    ...
    __generator =
        ...
        function (n, o) {
            var s,
                ...
                c = { next: t(0), throw: t(1), return: t(2) };
            return (
                    ...
                    for (; (h = c && e[(c = 0)] ? 0 : h); )
                        try {
                            ...
                            switch (((r = 0), (e = a ? [2 & e[0], a.value] : e)[0])) {
                                ...
                                default:
                                    if (
                                        !(a = 0 < (a = h.trys).length && a[a.length - 1]) &&
                                        (6 === e[0] || 2 === e[0])
                                    ) {
                                        h = 0;
                                        continue;
...
function launch() {
    ...
    t === Sponsor.eSponsorID.NONE
        ? new Sponsor.SponsorNone(e)
        : t === Sponsor.eSponsorID.COOLMATHGAMES && new Sponsor.SponsorCoolmathGames(e),
        Utils.StorageUtils.load(App.Config.saveKey)
            .then(function (t) {
...
!(function (t) {
    ...
    (e.prototype.spawn = function () {
        return 0 === this._count
            ? (this.debug, this._canGrow ? this.newItem() : null)
            : (this.debug, this._pool[--this._count]);
    }),
        ...
        (a.randomizeArray = function (t, e, i, n) {
            ...
            (a.sort = function (t, e, i, n) {
                if ((i = void 0 === i ? 0 : i) < (n = void 0 === n ? t.length : n)) {
                    for (var o, s = i, r = i + 1; r <= n; r++)
                        0 < e(t[i], t[r]) && ((o = t[++s]), (t[s] = t[r]), (t[r] = o));
    ...
    (function (t) {
        ...
        (l.addSpriteIntoFont = function (t, e, i, n, o, s, r, a) {
            void 0 === r && (r = l.ALIGN_CENTER),
                void 0 === a && (a = 0.5),
                "string" == typeof (s = void 0 === s ? "0" : s) && (s = s.charCodeAt(0));
            ...
            if (null == c)
                throw new Error(
                    "Reference character "
                        .concat(String.fromCharCode(s), " with code ")
                        .concat(s, " is mssing in font. Try another.")
                );
            (s = null),
                (t = (s = "string" == typeof n ? t.cache.getFrameByName(i, n) : t.cache.getFrameByIndex(i, n))
                    .sourceSizeW),
                (i = s.sourceSizeH),
                (n = c.yOffset + (r === l.ALIGN_CENTER ? c.height / 2 : r === l.ALIGN_BOTTOM ? c.height : 0)),
                (r = Math.round(n - i * a));
            h[o] = {
                x: s.x,
                y: s.y,
    ...
    (function (t) {
        ...
        (_.create = function (t, e, i, n, o, s, r, a, h, c, l, u) {
            ...
            return (
                (_._scaleCenterX = l),
                (_._scaleCenterY = u),
                _.calculateNineImage(n, e, i, s, r, a, h, c),
                (_._nineImage = new Phaser.BitmapData(t, "NineImage" + _._textureKey++, _._width, _._height)),
                _.renderNineImage(p),
                _._nineImage
            );
        }),
            (_.calculateNineImage = function (t, e, i, n, o, s, r, a) {
                (_._centralWidth = t.width - o - r),
                    (_._centralHeight = t.height - n - s),
                    a
                        ? ((_._horizontalRepeats = e),
                          (_._verticalRepeats = i),
                          (_._width = o + r + _._centralWidth * e),
                          (_._height = n + s + _._centralHeight * i),
                          (_._lastWidth = 0),
                          (_._lastHeight = 0))
                        : ((t = e - o - r),
                          (_._horizontalRepeats = Math.floor(t / _._centralWidth)),
                          (_._lastWidth = t % _._centralWidth),
                          (a = i - n - s),
                          (_._verticalRepeats = Math.floor(a / _._centralHeight)),
                          (_._lastHeight = a % _._centralHeight),
                          (_._width = e),
                          (_._height = i)),
                    (_._leftWidth = o),
                    (_._rightWidth = r),
            ...
            (_.renderNineImage = function (t) {
                ...
                if (
                    (0 < _._topHeight &&
                        (_.renderNineImageRow(t, e, i, _._topHeight), (e += _._topHeight), (i += _._topHeight)),
                    _._scaleCenterY)
                ) {
                    var n = _._verticalRepeats * _._centralHeight + _._lastHeight;
                    _.renderNineImageRow(t, e, i, _._centralHeight, n), (i += n);
                } else {
                    for (var o = 0; o < _._verticalRepeats; o++)
                        _.renderNineImageRow(t, e, i, _._centralHeight), (i += _._centralHeight);
            ...
            (_.renderNineImageRow = function (t, e, i, n, o) {
                ...
                if (
                    ((o = o || n),
                    0 < _._leftWidth &&
                        (_._nineImage.copy(t, s, e, _._leftWidth, n, r, i, _._leftWidth, o),
                        (r += _._leftWidth),
                        (s += _._leftWidth)),
                    _._scaleCenterX)
                ) {
                    ...
                    for (var h = 0; h < _._horizontalRepeats; h++)
                        _._nineImage.copy(t, s, e, _._centralWidth, n, r, i, _._centralWidth, o),
                            (r += _._centralWidth);
                    0 < _._lastWidth &&
                        (_._nineImage.copy(t, s, e, _._lastWidth, n, r, i, _._lastWidth, o), (r += _._lastWidth));
                }
                (s += _._centralWidth),
                    0 < _._rightWidth && _._nineImage.copy(t, s, e, _._rightWidth, n, r, i, _._rightWidth, o);
            }),
            (_._textureKey = 0),
            (t.NineImage = _);
    })((Helper = Helper || {})),
    (function (t) {
        var e = function (t, e, i) {
            ...
            e =
                ...
                (b.perlin3 = function (t, e, i) {
                    var n = Math.floor(t),
                        ...
                        r =
                            ...
                            (e -= o),
                            (i -= s),
                            b.gradP[(n &= 255) + b.perm[(o &= 255) + b.perm[(s &= 255)]]].dot3(t, e, i)),
                        ...
                        t = b.fade(i);
                    return b.lerp(
                        b.lerp(b.lerp(r, l, o), b.lerp(a, u, o), t),
                        b.lerp(b.lerp(h, p, o), b.lerp(c, n, o), t),
                        s
                    );
                }),
                (b.grad3 = [
                ...
                (b.perm = new Array(512)),
                (b.gradP = new Array(512)),
                (b.F2 = 0.5 * (Math.sqrt(3) - 1)),
                (b.G2 = (3 - Math.sqrt(3)) / 6),
                (b.F3 = 1 / 3),
                (b.G3 = 1 / 6),
                b);
        function b() {}
    ...
    (function (t) {
        ((e = I = I || {})[(e.UNDEFINED = -1)] = "UNDEFINED"),
            ...
            (M.wrapText = function (t, e, i, n, o, s, r) {
                ...
                for (
                    var e = (s = void 0 === s ? M.fontData.size : s) / M.fontData.size,
                        a = M.fontData.lineHeight * e,
                        h = i / e,
                        c = [],
                        l = [],
                        u = [],
                    ...
                    for (var g = 0, m = 0, y = -1, v = I.UNDEFINED, S = I.UNDEFINED, P = h, b = -1; M.hasNext(); ) {
                        ...
                        if (v === I.SPACE) S !== I.SPACE && (m = g), ++g, (P -= M.getCharAdvance(O, b));
                            ...
                            if (
                                (M.hasNext() &&
                                    ((A = !0), (m = g), (d = y = M.getPosition()), (P = -1), (v = I.CHARACTER)),
                                A)
                            )
                                break;
                        }
                    ...
                    (f -= a) < 0 && (u[_++] = p),
                        P < 0 && v === I.CHARACTER
                            ? ((l[p] = 0 !== m ? m : g),
                              f < 0 && (f = n - a),
                              0 !== m ? ((c[++p] = y), M.setPosition(y)) : ((c[++p] = d), M.setPosition(d)))
                            : M.hasNext() || (v === I.CHARACTER ? (l[p] = g) : v === I.SPACE && (l[p] = m));
                }
                u[_] = p + 1;
                for (var T = [], E = 1; E <= _; E++) {
    ...
    (function (i) {
        function n(t, e) {
            (this.maxVelocity = n.MAX_VELOCITY),
                (this._delay = 0),
        ...
        Object.defineProperty(n.prototype, "visual", {
            ...
            (n.prototype.setPhysics = function (t, e, i, n, o, s) {
                void 0 === i && (i = 0),
                    ...
                    void 0 === o && (o = 0),
                    void 0 === s && (s = 0),
                    this._velocity.setTo((t = void 0 === t ? 0 : t), (e = void 0 === e ? 0 : e)),
                    (this._angularVelocity = i),
                    (this._friction = n),
                    (this._angularDrag = o),
                    (this._gravity = s),
                    (this._simplePhysics = 0 === s && 0 === n && 0 === o);
            }),
            ...
            (n.prototype.setFrame = function (t) {}),
            (n.prototype.onEmit = function (t) {
                t.add(this._visual);
            }),
            (n.prototype.onKill = function (t) {}),
            (n.prototype.update = function (t, e) {
                ...
                return !(
                    (0 < this.lifetime && (this.lifetime -= t) <= 0) ||
                    ((0 === this._velocity.x && 0 === this._velocity.y) ||
                        ((this._visual.x += this._velocity.x * t), (this._visual.y += this._velocity.y * t)),
                    0 !== this._angularVelocity && (this._visual.angle += this._angularVelocity * t),
                    this._simplePhysics ||
                        ((this._velocity.x += -this._friction * this._velocity.x * t),
                        (this._velocity.y += (this._gravity - this._friction * this._velocity.y) * t),
                        (this._angularVelocity += -this._angularDrag * this._angularVelocity * t)),
                    e &&
                        (this._scaleChangeType != i.eParameterChangeType.NO_CHANGE &&
                            this._scaleChangeType === i.eParameterChangeType.IN_TIME &&
                            ((this._visual.scale.x += this._scaleChange * t) < 0 &&
                                ((this._visual.scale.x = 0), this._scaleChange < 0) &&
                                (this._scaleChangeType = i.eParameterChangeType.NO_CHANGE),
                            (this._visual.scale.y += this._scaleChange * t) < 0) &&
                            ((this._visual.scale.y = 0), this._scaleChange < 0) &&
                            (this._scaleChangeType = i.eParameterChangeType.NO_CHANGE),
                        this._alphaChangeType != i.eParameterChangeType.NO_CHANGE) &&
                        this._alphaChangeType === i.eParameterChangeType.IN_TIME &&
                        ((this._alpha += this._alphaChange * t),
                        this._alpha < 0
                            ? ((this._visual.alpha = 0),
                              this._alphaChange < 0 && (this._alphaChangeType = i.eParameterChangeType.NO_CHANGE))
                            : 1 < this._alpha
                              ? ((this._visual.alpha = 1),
                                0 < this._alphaChange && (this._alphaChangeType = i.eParameterChangeType.NO_CHANGE))
    ...
    (function (t) {
        (s = t.SpriteParticle),
            __extends(i, s),
            (i.prototype.onCreate = function (t) {
    ...
    (function (n) {
        function s(t) {
            (this.area = new Phaser.Point(0, 0)),
                ...
                (this.maxScale = 1),
                (this.scaleChange = 0),
                (this.scaleChangeType = n.eParameterChangeType.NO_CHANGE),
                (this.minAngle = 0),
                (this.maxAngle = 0),
                (this.minSpeedX = 0),
                (this.maxSpeedX = 0),
                ...
                (this.maxAlpha = 1),
                (this.alphaChange = 0),
                (this.alphaChangeType = n.eParameterChangeType.NO_CHANGE),
                (this.frames = null),
        ...
        (s.readParams = function (t, e) {
            ...
            (s.doReadParams = function (t, e, i) {
                var n,
                    o = e[i];
                for (n in (void 0 !== o.parent && null !== o.parent && ((i = o.parent), s.doReadParams(t, e, i)), o))
                    "parent" !== n && (t[n], (t[n] = o[n]));
            }),
                ...
                return (t =
                    null !== this.frames
                        ? Array.isArray(this.frames)
                            ? (this.frames[0], this._game.rnd.pick(this.frames))
                            : this.frames
                        : t);
            }),
            ...
            (s.prototype.setAdvScale = function (t, e, i, n) {
                void 0 === e && (e = 1),
                    void 0 === n && (n = 1),
                    this._minAdvScale.setTo((t = void 0 === t ? 1 : t), (i = void 0 === i ? 1 : i)),
    ...
    (function (s) {
        ((t = r = r || {})[(t.NONE = 0)] = "NONE"),
            ...
            ((t = n = s.eParameterChangeType || (s.eParameterChangeType = {}))[(t.NO_CHANGE = 0)] = "NO_CHANGE"),
            (t[(t.IN_TIME = 1)] = "IN_TIME"),
            (a = Phaser.Group),
            __extends(h, a),
            Object.defineProperty(h.prototype, "params", {
                get: function () {
                    return this._params;
                },
                set: function (t) {
            ...
            (h.prototype.update = function () {
                ...
                if (
                    ...
                    if (-1 !== this._flowTotal && this._flowCounter >= this._flowTotal) this.stopFlow();
                        ...
                        for (
                            var e = Math.max(1, this._flowQuantity), i = 0;
                            i < e &&
                            !(
                                this.emitParticle(this.forceEmit) &&
                                (this._flowCounter++, -1 !== this._flowTotal) &&
                                this._flowCounter >= this._flowTotal
                            );
                            i++
                        );
                for (
                    var n = null != (t = this.game.time.physicsElapsed) ? t : this.game.time.delta / 1e3,
                        i = this._counterUsed - 1;
                    0 <= i;
                    i--
                ) {
                    ...
                    o.update(n) ||
                        ...
                        (this._particlesPool[this._counterPool++] = o));
                }
            }),
            ...
            (h.prototype.flow = function (t, e, i, n, o, s) {
                (this._mode = r.FLOW),
                    ...
                    void 0 === i && (i = -1),
                    void 0 === n && (n = !0),
                    (e = void 0 !== e && 0 !== e ? e : 1) > this._maxParticles && (e = this._maxParticles),
                    (this.frequency = t),
                    (this._flowCounter = 0),
                    (this._flowQuantity = e),
                    (this._flowTotal = i),
                    n &&
                        (this.emitParticles(e, o, s),
                        (this._flowCounter += e),
            ...
            (h.prototype.emitParticle = function (t, e) {
                if ((void 0 === t && (t = !1), void 0 === e && (e = !1), 0 === this._counterPool)) {
                    ...
                    (this._particlesUsed[0] = this._particlesUsed[--this._counterUsed]),
                        t.remove(),
                        t.onKill(this),
                        (this._particlesPool[this._counterPool++] = t);
                }
                var t = this._particlesPool[--this._counterPool],
                    i =
                        (((this._particlesUsed[this._counterUsed++] = t).on = !0),
                        null !== this._alternativeParams ? this._alternativeParams : this._params);
                return (
                    this.randomEmitPoint(this._emitPoint, i),
                    t.visual.position.set(this._emitPoint.x, this._emitPoint.y),
                    (t.visual.angle = 0),
                    e
                        ? ((t.lifetime = -1),
                          t.visual.scale.set(1, 1),
                          t.setScaleChange(n.NO_CHANGE),
                          (t.visual.angle = 0),
                          (t.alpha = 1),
                          t.setAlphaChange(n.NO_CHANGE),
                          t.setPhysics())
                        : ((t.lifetime = this.game.rnd.realInRange(i.minLifetime, i.maxLifetime)),
                          (t.delay = i.delay),
                          1 !== i.minScale || 1 !== i.maxScale
                              ? ((e = this.game.rnd.realInRange(i.minScale, i.maxScale)), t.visual.scale.set(e, e))
                              : i.advScaleMin.x !== i.advScaleMax.x || i.advScaleMin.y !== i.advScaleMax.y
                                ? t.visual.scale.set(
                                      this.game.rnd.realInRange(i.advScaleMin.x, i.advScaleMax.x),
                                      this.game.rnd.realInRange(i.advScaleMin.y, i.advScaleMax.y)
                                  )
                                : t.visual.scale.set(1, 1),
                          t.setScaleChange(i.scaleChangeType, i.scaleChange),
                          (t.visual.angle =
                              i.minAngle === i.maxAngle
                                  ? i.minAngle
                                  : this.game.rnd.realInRange(i.minAngle, i.maxAngle)),
                          (t.alpha = this.game.rnd.realInRange(i.minAlpha, i.maxAlpha)),
                          t.setAlphaChange(i.alphaChangeType, i.alphaChange),
                          t.setPhysics(
                              this.game.rnd.realInRange(i.minSpeedX, i.maxSpeedX),
                              this.game.rnd.realInRange(i.minSpeedY, i.maxSpeedY),
                              this.game.rnd.realInRange(i.minAngularSpeed, i.maxAngularSpeed),
                              i.friction,
                              i.angularDrag,
                              i.gravity
                          ),
                          null !== i.frames && t.setFrame(i.randomFrame())),
                    t.onEmit(this),
                    this.particleBringToTop ? t.bringToTop() : this.particleSendToBack && t.sendToBack(),
                    t
                );
            }),
            ...
            (h.prototype.randomEmitPoint = function (t, e) {
                return (
                    ...
                    null !== this.emitObject && ((t.x += this.emitObject.x), (t.y += this.emitObject.y)),
                    t
                );
            }),
        ...
        function h(t, e, i, n) {
            ...
            return (
                (o._maxParticles = h.MAX_PARTICELES),
                (o.emitPoint = new Phaser.Point(0, 0)),
                (o.emitObject = null),
                (o.particleClass = s.SpriteParticle),
                (o.particleBringToTop = !1),
                (o.particleSendToBack = !1),
                (o.frequency = 100),
                (o.forceEmit = !1),
                (o._alternativeParams = null),
                (o._on = !1),
                (o._mode = r.NONE),
                (o._flowQuantity = 0),
                (o._flowTotal = 0),
                ...
                (o._counterUsed = 0),
                (o._timer = 0),
                (o._emitPoint = new Phaser.Point(0, 0)),
                (o._params = new s.ParticleParams(t)),
                o.position.setTo(e, i),
                (o._maxParticles = n),
                o
            );
        }
    ...
    (function (t) {
        ...
        (e.prototype.emit = function (t, e, i, n, o) {
            for (
                this._emitter.emitAt(t, e), null !== this._animEmitter && this._animEmitter.emitAt(t, e);
                null !== i;

            ) {
                var s,
                    r = i.animated ? this._animEmitter : this._emitter;
                null === this._params && i.paramsName,
                    null !== this._params && void 0 !== (s = this._params[i.paramsName]) && (r.params = s),
    ...
    (function (t) {
        ...
        Object.defineProperty(e, "instance", {
            ...
            (e.prototype.remove = function (t) {
                for (var e = this._emittersCount - 1; 0 <= e && this._emitters[e] !== t; e--);
    ...
    (function (t) {
        (c = Phaser.Group),
            ...
            (i.prototype.setButton = function (t, e) {
                if (
                    ...
                    if (
                        (Phaser.Point.multiply(this._saveScale, this.scaleOnDown, this._button.scale),
                    ...
                    if (
                        (Phaser.Point.multiply(this._saveScale, this.scaleOnOver, this._button.scale),
            ...
            (i.prototype.overAction = function () {}),
            (i.prototype.outAction = function () {}),
            (i.prototype.downAction = function () {
                Utils.AudioUtils.playSound("click");
            }),
            (i.prototype.upAction = function () {}),
        ...
        function i(t, e, i, n, o, s, r) {
            var a = c.call(this, t) || this,
                h =
                    ((a.onClick = new Phaser.Signal()),
                    (a.onDown = new Phaser.Signal()),
                    (a.scaleOnOver = new Phaser.Point(1, 1)),
                    (a.scaleOnDown = new Phaser.Point(1, 1)),
                    (a.offsetOnOver = new Phaser.Point(0, 0)),
                    (a.offsetOnDown = new Phaser.Point(0, 0)),
                    (a._tinted = !1),
                    (a._downTint = 8421504),
                    (a._overTint = 16777215),
                    (a._savePosition = new Phaser.Point()),
                    (a._saveScale = new Phaser.Point()),
                    (a._over = !1),
                    (a._down = !1),
                    (a.name = e),
                    new Phaser.Button(t, 0, 0, i));
            return (
                a.add(h),
                (a._button = h),
                void 0 !== o && o && (a._tinted = !0),
                void 0 === s &&
                    ((s = "string" == typeof n ? n + "Down" : null),
                    a._tinted || (s && !t.cache.getFrameByName(i, s))) &&
                    (s = null),
                void 0 === r &&
                    ((r = "string" == typeof n ? n + "Over" : null),
                    a._tinted || (r && !t.cache.getFrameByName(i, r))) &&
                    (r = null),
                h.setFrames(r, n, s, n),
                h.anchor.setTo(0.5, 0.5),
                (h.name = e),
                h.onInputOver.add(a.overEvent, a),
                h.onInputOut.add(a.outEvent, a),
                h.onInputDown.add(a.downEvent, a),
                h.onInputUp.add(a.upEvent, a),
                a
            );
        }
        t.Button = e;
    ...
    (function (t) {
        (h = t.Button),
            ...
            Object.defineProperty(i.prototype, "checked", {
                ...
                set: function (t) {
                    (this._checked = t)
                        ? ((this._checkSprite.frameName = this._frameChecked), (this._checkSprite.visible = !0))
                        : ((t = null !== this._frameUnchecked) && (this._checkSprite.frameName = this._frameUnchecked),
                          (this._checkSprite.visible = t));
                },
                enumerable: !1,
                configurable: !0,
            }),
        ...
        function i(t, e, i, n, o, s, r, a) {
            (e = h.call(this, t, e, i, n, s, r, a) || this),
                (e._changeOnDown = !1),
                (e._checkFramePosition = new Phaser.Point()),
                (e._checked = !1),
                (n = o + "On"),
                e.game.cache.getFrameByName(i, n),
                (e._frameChecked = n),
                (s = o + "Off"),
                e.game.cache.getFrameByName(i, n) || (s = null),
                (e._frameUnchecked = s),
                (r = new Phaser.Sprite(t, 0, 0, i));
            return r.anchor.set(0.5, 0.5), e.addChild(r), (e._checkSprite = r), (e.checked = !1), e;
        }
        t.CheckBox = e;
    })((UI = UI || {})),
    (function (t) {
        (r = t.Button),
            __extends(i, r),
            Object.defineProperty(i.prototype, "toggled", {
                get: function () {
                    return this._toggled;
                },
                set: function (t) {
                    (this._toggled = t)
                        ? (this._button.setFrames(null, this._frameToggled, this._frameToggled, this._frameToggled),
                          this._changeOnDown && (this._button.frameName = this._frameToggled))
                        : (this._button.setFrames(
                              null,
                              this._frameUntoggled,
                              this._frameUntoggled,
                              this._frameUntoggled
                          ),
    ...
    (function (t) {
        ((e = t.eGroupPlacement || (t.eGroupPlacement = {}))[(e.TOP_LEFT = 0)] = "TOP_LEFT"),
            (e[(e.TOP = 1)] = "TOP"),
            ...
            (i = Phaser.Group),
            __extends(n, i),
            (n.prototype.hasGroupAt = function (t) {
                t = this._groups[t];
                return null != t;
            }),
            (n.prototype.groupAt = function (t, e) {
                ...
                return (
                    null == i &&
                        e &&
                        (((i = new Phaser.Group(this.game, this)).fixedToCamera = !0),
                        (this._groups[t] = i),
                        this.arrangeGroup(t)),
                    i
                );
            ...
            (n.prototype.arrangeGroup = function (t) {
                var e = t % 3,
                    ...
                    t = this._groups[t];
                null != t &&
                    ((e = (this.game.width * e) / 2), (i = (this.game.height * i) / 2), t.cameraOffset.set(e, i));
            });
        var i,
            e = n;
        function n(t, e) {
    ...
    (function (t) {
        ...
        (n.setSounds = function (t, e) {
            void 0 === e && (e = null),
                (n._sfx = t),
                (n._sfxIds = e),
                (n._isAudioSprite = null !== t && t instanceof Phaser.AudioSprite);
        }),
            ...
            (n.playSound = function (t, e) {
                void 0 === e && (e = 1);
                t = n.getSoundName(t);
                App.settings.soundOn &&
                    (null !== n._sfx
                        ? n._isAudioSprite
                            ? n._sfx.play(t, e)
                            : n._sfx.play(t, 0, e)
                        : void 0 !== n._sfxs[t] && n._sfxs[t].play("", 0, e));
            }),
            ...
            Object.defineProperty(n, "isMusicPlaying", {
                get: function () {
                    return (
                        null !== this._currentMusic &&
                        0 !== this._currentMusic.length &&
                        n._music[n._currentMusic].isPlaying
                    );
                },
                enumerable: !1,
                configurable: !0,
            ...
            (n.playMusic = function (t, e) {
                ...
                void 0 === e && (e = !0),
                    n._currentMusic !== t &&
                        (null !== n._currentMusic && 0 < n._currentMusic.length && n.stopMusic(), t in n._music) &&
                        App.settings.musicOn &&
                        ((n._currentMusic = t),
                        ((i = n._music[t]).loop = e),
                        i.play(),
                        e ||
                            i.onStop.addOnce(function () {
                                n.onFinished.dispatch(t);
                            }, this));
            }),
            (n.stopMusic = function () {
                var t;
                null !== n._currentMusic &&
                    0 < n._currentMusic.length &&
                    ((t = n._music[n._currentMusic]).isPlaying && t.stop(), (n._currentMusic = ""));
            }),
            (n.pauseMusic = function () {
                var t;
                null !== n._currentMusic &&
                    0 < n._currentMusic.length &&
                    (t = n._music[n._currentMusic]).isPlaying &&
                    t.pause();
            }),
            (n.resumeMusic = function () {
                ...
                null !== n._currentMusic &&
                    0 < n._currentMusic.length &&
                    (t = n._music[n._currentMusic]).paused &&
                    t.resume();
            }),
            (n._sfx = null),
            (n._isAudioSprite = !1),
            ...
            (n._music = {}),
            (n._currentMusic = ""),
            (n.onFinished = new Phaser.Signal()),
            (t.AudioUtils = n);
    })((Utils = Utils || {})),
    (function (t) {
        function i() {}
        (i.saveTextAsFile = function (t, e) {
            (t = new Blob([t], { type: "text/plain" })),
                null !== i._textFile && window.URL.revokeObjectURL(i._textFile),
                (i._textFile = window.URL.createObjectURL(t)),
        ...
        (e.ChangeAnimationPhaserJSONData = function (t) {
            (Phaser.AnimationParser.myCallback = t),
                (Phaser.AnimationParser.JSONData = function (t, e) {
                    ...
                    for (var i = new Phaser.FrameData(), n = e.frames, o = 0; o < n.length; o++) {
                        var s = i.addFrame(
                            new Phaser.Frame(o, n[o].frame.x, n[o].frame.y, n[o].frame.w, n[o].frame.h, n[o].filename)
                        );
                        n[o].trimmed &&
                            s.setTrim(
                                n[o].trimmed,
                                n[o].sourceSize.w,
                                n[o].sourceSize.h,
                                n[o].spriteSourceSize.x,
                                n[o].spriteSourceSize.y,
                                n[o].spriteSourceSize.w,
                                n[o].spriteSourceSize.h
                            ),
                            Phaser.AnimationParser.myCallback(s, n[o]);
                    }
                    return i;
                });
        }),
            ...
            (e.AddBitmapFontAddMethod = function () {
                Phaser.Cache.prototype.addBitmapFontFromImage = function (t, e, i, n, o, s, r) {
                    (i = this.getImage(i, !0)), (i = { url: e, data: i.data, font: null, base: i.base });
                    void 0 === s && (s = 0),
                        void 0 === r && (r = 0),
                        (i.font =
                            "json" === o
                                ? Phaser.LoaderParser.jsonBitmapFont(n, i.base, s, r)
                                : Phaser.LoaderParser.xmlBitmapFont(n, i.base, s, r)),
                        (this._cache.bitmapFont[t] = i),
                        this._resolveURL(e, i);
                };
            }),
            (t.PhaserUtils = e);
    })((Utils = Utils || {})),
    (function (t) {
        var d,
            ...
            e =
                ((t.ScreenMetrics = f),
                ((e = d = t.eOrientation || (t.eOrientation = {}))[(e.PORTRAIT = 0)] = "PORTRAIT"),
                (e[(e.LANDSCAPE = 1)] = "LANDSCAPE"),
                (i.calculateScreenMetrics = function (t, e, i, n, o, s) {
                    void 0 === i && (i = d.LANDSCAPE),
                        (((r = window.innerWidth) < (a = window.innerHeight) && i === d.LANDSCAPE) ||
                            (a < r && i === d.PORTRAIT)) &&
                            !n &&
                            ((h = r), (r = a), (a = h)),
                        (void 0 !== o && void 0 !== s) ||
                            (s =
                                i === d.LANDSCAPE
                                    ? ((o = Math.round((1024 * t) / 960)), Math.round((720 * e) / 600))
                                    : ((o = Math.round((720 * t) / 600)), Math.round((1024 * e) / 960)));
                    var r,
                        a,
                        h = t / e,
                        c = r / a,
                        ...
                        u =
                            h < c
                                ? ((_ = e), (p = 2 * Math.ceil((_ * c) / 2)), (l = ((p = Math.min(p, o)) - t) / 2), 0)
                                : ((p = t), (_ = 2 * Math.ceil(p / c / 2)), (l = 0), ((_ = Math.min(_, s)) - e) / 2),
                        h = (r + 0.01) / p,
                        c = (a + 0.01) / _;
                    return (
                        n && i === d.LANDSCAPE && (h = c),
                        (this.screenMetrics = new f()),
                        ...
                        (this.screenMetrics.maxGameWidth = o),
                        (this.screenMetrics.maxGameHeight = s),
                        (this.screenMetrics.gameWidth = p),
                        (this.screenMetrics.gameHeight = _),
                        (this.screenMetrics.scaleX = h),
                        (this.screenMetrics.scaleY = c),
                        (this.screenMetrics.offsetX = l),
                        (this.screenMetrics.offsetY = u),
                        this.screenMetrics
                    );
                }),
                i);
    ...
    (function (t) {
        ...
        Object.defineProperty(r, "sponsorStorage", {
            ...
            (r.save = function (o, s) {
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (t) {
                        switch (t.label) {
                            case 0:
                                if (!r._allowMultipleRequests && 0 < r._requestsCounter)
                                    throw new Error("Previous load/save request was not finished yet");
                                return (
                                    ++r._requestsCounter, null === (e = r._sponsorStorage) ? [3, 2] : [4, e.save(o, s)]
                                );
                            case 1:
                                if ((t.sent(), !e.fallbackToStandardStorage())) return --r._requestsCounter, [2];
                                t.label = 2;
                            case 2:
                                if (null === (i = r.getLocalStorage()))
                                    throw (--r._requestsCounter, new Error("Standard storage not available"));
                    ...
                    return __generator(this, function (t) {
                        switch (t.label) {
                            case 0:
                                ...
                                return (
                                    ++r._requestsCounter,
                                    (e = null) === (i = r._sponsorStorage) ? [3, 2] : [4, i.load(o)]
                                );
                            case 1:
                                if (null != (e = t.sent()) || !i.fallbackToStandardStorage())
                                    return --r._requestsCounter, [2, e];
                                t.label = 2;
                            case 2:
                                if (null === (n = r.getLocalStorage()))
                                    throw (--r._requestsCounter, new Error("Standard storage not available"));
            ...
            (r._sponsorStorage = null),
            (r._allowMultipleRequests = !0),
            (r._requestsCounter = 0),
            (t.StorageUtils = r);
    })((Utils = Utils || {})),
    (function (t) {
        function a() {}
        (a.padNumber = function (t, e, i) {
            ...
            (a.formatTime = function (t, e, i, n) {
                ...
                var o,
                    ...
                    r = "",
                    e =
                        ((3600 < (t = Math.floor(t)) || 0 === e) &&
                            ((o = Math.floor(t / 3600)),
                            (r += (-1 !== i ? a.padNumber(o, i) : o) + n),
                            (t %= 3600),
                            (s = !0)),
                        (!0 === s || 60 < t || 1 === e) &&
                            ((o = Math.floor(t / 60)),
    ...
    (function (t) {
        ...
        (n.setTexts = function (t) {
                ...
                return (t =
                    !(t =
                        navigator && navigator.userAgent
                            ? (t = navigator.userAgent.match(/android.*\W(\w\w)-(\w\w)\W/i)) && t[1]
                            : t) && navigator
                        ? (navigator.language
                              ? (t = navigator.language)
                              : navigator.languages && 0 < navigator.languages.length
                                ? (t = navigator.languages[0])
                                : navigator.browserLanguage
                                  ? (t = navigator.browserLanguage)
                                  : navigator.systemLanguage
                                    ? (t = navigator.systemLanguage)
                                    : navigator.userLanguage && (t = navigator.userLanguage),
            ...
            (n.getText = function (t, e) {
                ...
                i = i[t];
                if (void 0 === i)
                    throw new Error("Text with text id: ".concat(t, " for language ").concat(e, " is missing."));
                return i;
            }),
            (n._texts = null),
            (n._sponsorText = null),
                        ...
                        function () {
                            ...
                            return (
                                !this.noAudio &&
                                    ...
                                    this.usingWebAudio &&
                                    ((t = this.context.createBuffer(1, 1, 22050)),
    ...
    (function (t) {
        ((t = t.eSponsorID || (t.eSponsorID = {}))[(t.NONE = 0)] = "NONE"),
            ...
            (t[(t.WANTED5GAMES = 8)] = "WANTED5GAMES"),
            (t[(t.ORANGEFR = 9)] = "ORANGEFR"),
            (t[(t.WKB = 10)] = "WKB"),
            (t[(t.MONDIA = 11)] = "MONDIA"),
            (t[(t.GAMEARTER = 12)] = "GAMEARTER"),
            (t[(t.KAPOW = 13)] = "KAPOW"),
            (t[(t.YANDEX = 14)] = "YANDEX"),
            (t[(t.GAMEDISTRIBUTION = 15)] = "GAMEDISTRIBUTION"),
            (t[(t.THEBALANCE = 16)] = "THEBALANCE");
    })((Sponsor = Sponsor || {})),
    (function (t) {
        function e(t) {
        ...
        Object.defineProperty(e, "instance", {
            get: function () {
                if (null == e._instance)
                    throw new Error("Sponsor is ".concat(e._instance, ". Sponsor must be always initialized."));
                return e._instance;
            },
            enumerable: !1,
            configurable: !0,
    ...
    (function (t) {
        (e = t.Sponsor),
            __extends(n, e),
            (n.prototype.getSponsorLogoLink = function () {
                for (var t = 0; t < arguments.length; t++) t, 0;
    ...
    (function (t) {
        (i = t.Sponsor),
            ...
            (n.prototype.startGameSession = function () {
                ...
                var i = t[0];
                void 0 !== i.eventValue
                    ? void 0 !== parent.cmgGameEvent && parent.cmgGameEvent(i.eventName, "" + i.eventValue)
                    : void 0 !== parent.cmgGameEvent && parent.cmgGameEvent(i.eventName);
            }),
    ...
    (function (e) {
        ...
        (e.SPONSOR_FEATURES =
            ...
            t)),
            (e.getSponsorFeatures = function (t) {
                if (null == e.SPONSOR_FEATURES[t])
                    throw new Error(
                        "Features for sponsor ".concat(Sponsor.eSponsorID[t], " are not in SPONSOR_FEATURES list.")
                    );
    ...
    App.CORDOVA ||
        (App.sponsor === Sponsor.eSponsorID.FAMOBI ? (window.famobi_onload = launch) : (window.onload = launch)),
    (function (t) {
        function e() {}
        (e.GAME_WIDTH = 640),
            (e.GAME_HEIGHT = 1024),
            (e.MAX_GAME_WIDTH = 820),
            (e.MAX_GAME_HEIGHT = 1136),
            (e.scaleX = 1),
            (e.scaleY = 1),
            (e.saveKey = "snake_save"),
            (e.correctOrientation = !1),
            (e.showLanguages = !1),
            (e.supportedLanguages = ["en"]),
            (e.FIRE_SPONSOR_EVENTS = !0),
            (e.TAP_TOLERANCE_PIXELS = 30),
            (e.TAP_DEAD_BELT_IN_BLOCKS = 0),
            (e.SWIPE_DISTANCE = 50),
            (e.SWIPE_FINISHED_AFTER_MIN_DISTANCE = !0),
            (e.SWIPE_CONTINUOUS = !1),
            (e.IDEAL_BOARD_SIZE_IN_BLOCKS = 1200),
            (e.MIN_SPACE_FOR_UI = 60),
            (e.BG_COLOR = 0),
            (e.BORDER_COLOR = 1454668),
            (e.FOOD_COLOR = 16711680),
            (e.SNAKE_COLOR = 3530240),
            (e.SNAKE_BORDER_COLOR = 26138),
            (e.SNAKE_DEATH_COLOR = 12632256),
            (e.SNAKE_DEATH_BORDER_COLOR = 170),
            (e.SNAKE_BLOCK_BORDER_USE_PERCENT = !1),
            (e.SNAKE_BLOCK_BORDER_PIXELS = 1),
            (e.SNAKE_BLOCK_BORDER_PERCENT = 0.1),
            (e.SPEED_DESKTOP = 13.333),
            (e.SPEED_MOBILE = 7),
            (e.BLOCKS_ON_FOOD = 4),
            (e.TEXT_STYLE = { font: "20px Arial", fill: "#fff", align: "center" }),
            (e.TEXT_BUTTON_STYLE = { font: "24px Arial", fill: "#fff", align: "center" }),
            (t.Config = e);
    })((App = App || {})),
    (function (i) {
        (n = Phaser.Game),
            __extends(o, n),
            (o.prototype.onSound = function (t) {
                this.sound.mute = !t;
            }),
            (o.prototype.additionalFrameProperties = function (t, e) {
                e.anchor && ((t.anchorX = e.anchor.w), (t.anchorY = e.anchor.h)),
                    e.nextitem && ((t.nextItemX = e.nextitem.w), (t.nextItemY = e.nextitem.h));
            }),
            (o.game = null);
        var n,
            t = o;
    ...
    e = Phaser.AUTO,
    e = {
        width: Math.min(window.innerWidth * 0.9, 960),
        height: Math.min(window.innerHeight * 0.9 * (App.Config.GAME_HEIGHT / App.Config.GAME_WIDTH), 540),
        renderer: e,
   ...
   window.addEventListener("resize", function() {
    var newWidth = Math.min(window.innerWidth * 0.9, 960);
    var newHeight = Math.min(window.innerHeight * 0.9 * (App.Config.GAME_HEIGHT / App.Config.GAME_WIDTH), 540);
    t.scale.setGameSize(newWidth, newHeight);
});
            ...
            return (
                Sponsor.is(Sponsor.eSponsorID.WKB) && (e.mouseWheel = !1),
                (t = n.call(this, e) || this),
                (o.game = t),
                Utils.PhaserUtils.ChangeAnimationPhaserJSONData(t.additionalFrameProperties),
                Utils.PhaserUtils.AdjustTweenFunctions(),
                Utils.PhaserUtils.AddBitmapFontAddMethod(),
                t.state.add("Boot", i.Boot),
                t.state.add("Preloader", i.Preloader),
                t.state.add("Menu", i.Menu),
                t.state.add("Play", i.Play),
                t.state.add("OrientationWait", i.OrientationWait),
                t.state.start("Boot"),
                t
            );
        }
    ...
    (function (t) {
        ...
        (e.AUDIO_JSON = {
            ...
            spritemap: { GameOver: { start: 0, end: 1.05718820861678, loop: !1 } },
        }),
            (t.Sounds = e);
    })((Snake = Snake || {})),
    (function (t) {
    ...
    (function (n) {
        (o = Phaser.Group),
            ...
            (s.prototype.onResize = function (t, e) {
                t <= 0 ||
                    e <= 0 ||
                    (this.position.set(t / 2, e / 2),
                    (t = Math.min(t / this._savedDims.x, e / this._savedDims.y)),
                    this.scale.set(t));
            }),
            ...
            (s.prototype.calculateDimensions = function (t, e) {
                var i = t / e;
                for (
                    this._dims.x = Math.floor(Math.sqrt(App.Config.IDEAL_BOARD_SIZE_IN_BLOCKS * i)),
                        this._dims.y = Math.floor(this._dims.x / i),
                        this._blockSize = Math.min(Math.floor(t / this._dims.x), Math.floor(e / this._dims.y));
                    t - this._dims.x * this._blockSize < 2 * this._blockSize;

                )
                    --this._dims.x;
                for (; e - this._dims.y * this._blockSize < 2 * this._blockSize; ) --this._dims.y;
                for (
                    this.calculateInnerOffset(t, e);
                    e - this._innerOffset.y - this._dims.y * this._blockSize < App.Config.MIN_SPACE_FOR_UI;
            ...
            (s.prototype.calculateInnerOffset = function (t, e) {
                this._innerOffset.set(
                    Math.floor((t - this._dims.x * this._blockSize) / 2),
                    Math.floor((e - this._dims.y * this._blockSize) / 2)
                );
            }),
            (s.prototype.createGraphhics = function (t) {
                var e = App.Config.SNAKE_BLOCK_BORDER_PIXELS,
                    i =
                        t -
                        2 *
                            (e = App.Config.SNAKE_BLOCK_BORDER_USE_PERCENT
                                ? Math.floor(t * App.Config.SNAKE_BLOCK_BORDER_PERCENT)
                                : e);
            ...
            (s.prototype.updateBoard = function (t, e) {
                this._food.active || this.placeFood(),
                    this._snake.update(t, e) &&
                        (this.checkFood(), this.checkBorderCollision(), this.checkSnakeCollision());
            }),
            (s.prototype.placeFood = function () {
                var t = this._snake.blocks;
                do {
                    for (
                        var e = this.game.rnd.integerInRange(0, this._dims.x - 1),
                            i = this.game.rnd.integerInRange(0, this._dims.y - 1),
                            n = !1,
                            o = t.length - 1;
                        0 <= o;
                        o--
            ...
            (s.prototype.checkFood = function () {
                ...
                t.x === this._food.gridX &&
                    t.y === this._food.gridY &&
                    (this._parentState.onScore(App.Config.BLOCKS_ON_FOOD),
            ...
            (s._calculated = !1),
            (s._calcDims = new Phaser.Point()),
            (s._calcBlockSize = 0),
            (s._calcInnerOffset = new Phaser.Point()),
            (s._calcUICenterY = 0),
            (s._calcSavedDims = new Phaser.Point());
        var o,
            t = s;
        function s(t, e, i) {
            ...
            return (
                (e._parentState = null),
                (e._dims = new Phaser.Point()),
                (e._innerOffset = new Phaser.Point()),
                (e._borders = null),
                (e._inner = null),
                (e._food = null),
                (e._snake = null),
                ...
                (e._foodImage = null),
                (e._deathImage = null),
                (e._savedDims = new Phaser.Point()),
                (e._parentState = i),
                s._calculated
                    ? (e._dims.copyFrom(s._calcDims),
                      (e._blockSize = s._calcBlockSize),
                      e._innerOffset.copyFrom(s._calcInnerOffset),
                      (e._UICenterY = s._calcUICenterY),
                      e._savedDims.copyFrom(s._calcSavedDims))
                    : (e.calculateDimensions(t.width, t.height),
                      e._savedDims.set(t.width, t.height),
                      s._calcDims.copyFrom(e._dims),
                      (s._calcBlockSize = e._blockSize),
                      s._calcInnerOffset.copyFrom(e._innerOffset),
                      (s._calcUICenterY = e._UICenterY),
                      s._calcSavedDims.copyFrom(e._savedDims),
                      (s._calculated = !0)),
                (e._borders = new n.Borders(t, e, e._savedDims)),
                e.createGraphhics(e._blockSize),
                e._borders.resize(e._innerOffset, e._dims, e._blockSize),
                (e._inner = new Phaser.Group(t, e)),
                (e._snake = new n.Snake(t, e, e._snakeImage, e._dims)),
                (e._food = new n.Food(t, e._foodImage)),
                e._inner.add(e._food),
                e.position.set(e._savedDims.x / 2, e._savedDims.y / 2),
                e._inner.position.set(e._innerOffset.x - e.x, e._innerOffset.y - e.y),
                e.onDestroy.add(function () {
                    null !== this._snakeImage && (this._snakeImage.destroy(), (this._snakeImage = null)),
                        null !== this._foodImage && (this._foodImage.destroy(), (this._foodImage = null)),
                        null !== this._deathImage && (this._deathImage.destroy(), (this._deathImage = null));
                }, e),
                e
            );
        }
    ...
    (function (t) {
        (n = Phaser.Group),
            ...
            (o.prototype.resize = function (t, e, i) {
                this._left.position.set(t.x - this._dims.x / 2, 0),
                    (this._left.width = t.x),
                    (this._left.height = this._dims.y);
                var n = t.x + e.x * i,
                    n =
                        (this._right.position.set(n - this._dims.x / 2, 0),
                        (this._right.width = this._dims.x - n),
                        (this._right.height = this._dims.y),
                        this._top.position.set(0, t.y - this._dims.y / 2),
                        (this._top.width = this._dims.x),
                        (this._top.height = t.y),
                        t.y + e.y * i);
                this._bottom.position.set(0, n - this._dims.y / 2),
                    (this._bottom.width = this._dims.x),
                    (this._bottom.height = this._dims.y - n);
            }),
            (o.SPRITE_SIZE = 64);
        var n,
            e = o;
        function o(t, e, i) {
            ...
            return (
                ...
                (e._dims = null),
                (e._dims = i),
                (e._sprite = new Phaser.BitmapData(t, "border", o.SPRITE_SIZE, o.SPRITE_SIZE)),
                e._sprite.rect(0, 0, o.SPRITE_SIZE, o.SPRITE_SIZE, Phaser.Color.getWebRGB(App.Config.BORDER_COLOR)),
                (e._left = t.add.sprite(0, 0, e._sprite, 0, e)),
                e._left.anchor.set(1, 0.5),
                (e._right = t.add.sprite(0, 0, e._sprite, 0, e)),
                e._right.anchor.set(0, 0.5),
                (e._top = t.add.sprite(0, 0, e._sprite, 0, e)),
                e._top.anchor.set(0.5, 1),
                (e._bottom = t.add.sprite(0, 0, e._sprite, 0, e)),
                e._bottom.anchor.set(0.5, 0),
                e.onDestroy.add(function () {
    ...
    (function (t) {
        (o = Phaser.Group),
            ...
            (i.prototype.onResize = function (t) {
                ...
                this._length.position.set(this.game.width / 2 - t, e),
                    this._best.position.set(this.game.width / 2 + t, e);
            });
        var o,
            e = i;
        function i(t, e, i, n) {
            ...
            return (
                (e._length = null),
                (e._best = null),
                (e._length = t.add.text(0, 0, "", App.Config.TEXT_STYLE, e)),
                (e._length.align = "left"),
                e._length.anchor.set(0, 0.5),
                e._length.position.set(n, i),
                1 < t.device.pixelRatio && (e._length.fontSize = 2 * e._length.fontSize),
                (e._best = t.add.text(0, 0, "", App.Config.TEXT_STYLE, e)),
                (e._best.align = "right"),
                e._best.anchor.set(1, 0.5),
                e._best.position.set(t.width - n, i),
                1 < t.device.pixelRatio && (e._best.fontSize = 2 * e._best.fontSize),
                e
            );
        }
        t.BottomUI = e;
    ...
    (function (l) {
        (u = Phaser.Group),
            __extends(p, u),
            Object.defineProperty(p.prototype, "button", {
                get: function () {
                    return this._button;
                },
                enumerable: !1,
        ...
        function p(t, e, i, n, o, s, r) {
            ...
            var e = u.call(this, t, e) || this,
                ...
                c =
                    (((c % 2 == 1 && h.x % 2 == 0) || (c % 2 == 0 && h.x % 2 == 1)) && ++c,
                    (i = c * a),
                    Math.ceil(n / a));
            for (((c % 2 == 1 && h.y % 2 == 0) || (c % 2 == 0 && h.y % 2 == 1)) && ++c, n = c * a; i > h.x * a; )
                i -= 2 * a;
            return (
                (e._height = n),
                (e._width = i),
                (e._bg = t.add.sprite(0, 0, "Sprites", "Black", e)),
                (e._bg.width = i),
                (e._bg.height = n),
                e._bg.anchor.set(0.5, 0.5),
                (e._text = t.add.text(0, 0, "", App.Config.TEXT_STYLE, e)),
                e._text.anchor.set(0.5, 0),
                (e._text.y = -n / 2 + p.BORDER * s),
                (e._text.fontSize = e._text.fontSize * s),
                r &&
                    ((e._button = new l.TextButton(t, o)),
                    (e._button.y = n / 2 - 50 * s),
                    e.add(e._button),
                    e._button.scale.set(s)),
                (e.visible = !1),
                e
            );
        }
        ...
        (s = o.Dialog),
            ...
            (e.prototype.setScore = function (t, e) {
                var i = 1 < this.game.device.pixelRatio ? 2 : 1,
                    n = "";
                e
                    ? ((n = n + Utils.TextUtils.getText("TXT_CONGRATS") + "\n\n"),
                      (this._text.lineSpacing = -5),
                      (this._text.y = -this._height / 2 + (o.Dialog.BORDER / 2) * i),
                      (this._button.y = this._height / 2 - 40 * i),
                      this._text.addColor("#FFFF00", 0),
                      this._text.addColor("#FFFFFF", 16))
                    : ((n = n + Utils.TextUtils.getText("TXT_GAME_OVER") + "\n"),
                      (this._text.lineSpacing = Math.floor(0.85 * this._text.fontSize)),
                      (this._text.y = -this._height / 2 + o.Dialog.BORDER * i),
                      (this._button.y = this._height / 2 - 50 * i),
                      this._text.clearColors()),
                    (n = (n += Utils.TextUtils.getText("TXT_LENGTH")) + t.toString()),
                    (this._text.text = n);
            });
        var s,
            t = e;
    ...
    (function (t) {
        ...
        function i(t, e, i, n, o) {
            ...
            return (
                (t._text.text = Utils.TextUtils.getText("TXT_PAUSE")),
                (t._text.y = 0),
                t._text.anchor.set(0.5),
                (t._text.fontSize = 0.75 * t._text.fontSize),
                t
            );
        }
        t.DialogPause = e;
    ...
    (function (t) {
        ...
        function i(t, e, i, n, o) {
            ...
            return (
                t.device.desktop
                    ? (e._text.text = Utils.TextUtils.getText("TXT_START_PC"))
                    : (e._text.text = Utils.TextUtils.getText("TXT_START_MOBILE")),
                e
            );
        }
        t.DialogStart = e;
    ...
    (function (t) {
        ...
        (r.prototype.onDown = function (t) {
            this._parentState.blockInput ||
                ((this._down = !0), this._downPosition.copyFrom(t.position), (this._downTime = this._game.time.time));
        }),
            (r.prototype.onMove = function (t, e, i, n) {
                var o, s;
                this._down &&
                    Phaser.Point.subtract(t.position, this._downPosition, this._hlpPt).getMagnitude() >=
                        App.Config.SWIPE_DISTANCE &&
                    App.Config.SWIPE_FINISHED_AFTER_MIN_DISTANCE &&
                    ((o = this._board.snake.lastDirection),
                    (s = Phaser.Point.subtract(t.position, this._downPosition, this._hlpPt)),
                    App.Config.SWIPE_CONTINUOUS && this._downPosition.copyFrom(t.position),
                    0 !== o.x
                        ? Math.abs(s.y) > Math.abs(s.x) &&
                          (s.y < 0 ? this._direction.copyFrom(r.UP) : this._direction.copyFrom(r.DOWN))
                        : 0 !== o.y
                          ? Math.abs(s.x) > Math.abs(s.y) &&
                            (s.x < 0 ? this._direction.copyFrom(r.LEFT) : this._direction.copyFrom(r.RIGHT))
                          : Math.abs(s.y) > Math.abs(s.x)
                            ? s.y < 0
                                ? this._direction.copyFrom(r.UP)
                                : this._direction.copyFrom(r.DOWN)
                            : s.x < 0
                              ? this._direction.copyFrom(r.LEFT)
                              : this._direction.copyFrom(r.RIGHT));
            }),
            (r.prototype.onUp = function (t) {
                var e, i, n;
                this._down &&
                    ((this._down = !1),
                    (e = Phaser.Point.subtract(t.position, this._downPosition, this._hlpPt).getMagnitude()) <
                        App.Config.TAP_TOLERANCE_PIXELS &&
                        ((n = this._board.snake.blocks[0].world),
                        (i = this._board.snake.lastDirection),
                        (n = Phaser.Point.subtract(t.position, n, this._hlpPt)),
                        0 !== i.x
                            ? Math.abs(n.y) > (this._board.blockSize * App.Config.TAP_DEAD_BELT_IN_BLOCKS) / 2 &&
                              (n.y < 0 ? this._direction.copyFrom(r.UP) : this._direction.copyFrom(r.DOWN))
                            : 0 !== i.y
                              ? Math.abs(n.x) > (this._board.blockSize * App.Config.TAP_DEAD_BELT_IN_BLOCKS) / 2 &&
                                (n.x < 0 ? this._direction.copyFrom(r.LEFT) : this._direction.copyFrom(r.RIGHT))
                              : Math.abs(n.y) > Math.abs(n.x)
                                ...
                                : n.x < 0
                                  ? this._direction.copyFrom(r.LEFT)
                                  : this._direction.copyFrom(r.RIGHT)),
                    e >= App.Config.SWIPE_DISTANCE) &&
                    !App.Config.SWIPE_FINISHED_AFTER_MIN_DISTANCE &&
                    ((i = this._board.snake.lastDirection),
                    (n = Phaser.Point.subtract(t.position, this._downPosition, this._hlpPt)),
                    0 !== i.x
                        ? Math.abs(n.y) > Math.abs(n.x) &&
                          (n.y < 0 ? this._direction.copyFrom(r.UP) : this._direction.copyFrom(r.DOWN))
                        : 0 !== i.y
                ...
                this._cursorKeys.left.isDown
                    ...
                    : this._cursorKeys.right.isDown
                      ...
                      : this._cursorKeys.up.isDown
                        ? this._direction.copyFrom(r.UP)
                        : this._cursorKeys.down.isDown && this._direction.copyFrom(r.DOWN);
            }),
            ...
            (r.LEFT = new Phaser.Point(-1, 0)),
            (r.RIGHT = new Phaser.Point(1, 0)),
            (r.UP = new Phaser.Point(0, -1)),
            (r.DOWN = new Phaser.Point(0, 1)),
            (t.Input = r);
    })((Snake = Snake || {})),
    (function (o) {
        function t(t, e, i, n) {
            (this._parent = null),
                ...
                (this._hlpPt = new Phaser.Point()),
                (this._parent = e),
                (this._pool = new Collections.Pool(o.Block, 200, function () {
                    return new o.Block(t, i);
                })),
                (this._pool.canGrow = !0),
                (this._blocks = []),
                (this._blocksToAdd = 0),
                this.addBlock(Math.floor(n.x / 2), Math.floor(n.y / 2)),
                (this._timeToMove = 1e3 / (t.device.desktop ? App.Config.SPEED_DESKTOP : App.Config.SPEED_MOBILE)),
        ...
        Object.defineProperty(t.prototype, "blocks", {
            ...
            (t.prototype.update = function (t, e) {
                return (
                    ((0 !== e.x && 0 === this._lastDirection.x) || (0 !== e.y && 0 === this._lastDirection.y)) &&
                        this._direction.copyFrom(e),
                    !(
                        (0 === this._direction.x && 0 === this._direction.y) ||
                        ((this._currentTimeToMove -= t), 0 < this._currentTimeToMove) ||
                        ((this._currentTimeToMove = this._timeToMove),
    ...
    (function (t) {
        ...
        function i(t, e) {
            ...
            return (
                (i._text = null),
                (i.downAction = function () {}),
                (i._text = t.add.text(0, 0, e, App.Config.TEXT_BUTTON_STYLE, i)),
                i._text.anchor.set(0.5),
                (i._text.y = Math.floor(0.15 * i._text.fontSize)),
                i
            );
        }
        t.TextButton = e;
        ...
        (e = Phaser.State),
            ...
            (n.prototype.preload = function () {
                this.load.json("Config", "assets/config.json"),
                    Sponsor.isFeatureOn("hasConfig") &&
                        this.load.json(
                            "SponsorConfig",
                            "assets/sponsor/config_".concat(Sponsor.features().name, ".json")
                        );
            }),
            (n.prototype.create = function () {
                var t = this.cache.getJSON("Config");
                if (!t) throw new Error("Game is missing file config.json at 'assets/'.");
                if ((Utils.ObjectUtils.loadValuesIntoObject(t, App.Config), this.cache.checkJSONKey("SponsorConfig")))
                    Utils.ObjectUtils.loadValuesIntoObject(this.cache.getJSON("SponsorConfig"), App.Config);
                else if (Sponsor.isFeatureOn("hasConfig"))
                    throw new Error(
                        "Sponsor features require sponsor specific config 'config_".concat(
                            Sponsor.features().name,
                            ".json' at 'assets/sponsor/'."
                        )
                    );
            ...
            (n.prototype.gameResized = function (t, e) {
                ...
                !t.incorrectOrientation &&
                    ...
                    n.x !== this.game.width ||
                        ...
                        0.001 < Math.abs(o.x - t) ||
                        0.001 < Math.abs(o.y - i)) &&
                    (this.scale.setGameSize(n.x, n.y),
                    this.scale.setUserScale(o.x, o.y),
                    "function" == typeof (t = this.game.state.getCurrentState()).onResize && t.onResize(n.x, n.y),
                    this.camera.update());
            }),
    ...
    (function (t) {
        (e = Phaser.State),
            __extends(n, e),
            (n.prototype.setView = function (t, e) {
        ...
        (i = e.SceneBase),
            ...
            (n.prototype.create = function () {
                (this.stage.backgroundColor = App.Config.BG_COLOR),
                    (this._score = 1),
                    (this._board = new e.Board(this.game, this.world, this)),
                    (this._ui = new e.BottomUI(
                        this.game,
                        this.world,
                        this._board.UICenterY,
                        this._board.innerOffset.x
                    )),
                    this._ui.setLength(this._score),
                    this._ui.setBest(App.settings.hiScore),
                    (this._input = new e.Input(this.game, this, this._board)),
                    (this._blockInput = !0),
                ...
                (this._dialogGameOver = new e.DialogGameOver(this.game, this.world, 360, 200, this._board)),
                    this._dialogGameOver.position.set(this.world.centerX, t),
                    this._dialogGameOver.button.onClick.add(function () {
                        this.restartGame();
                    }, this),
                    (this._dialogStart = new e.DialogStart(this.game, this.world, 450, 170, this._board)),
                    this._dialogStart.position.set(this.world.centerX, t),
                    this._dialogStart.button.onClick.add(function () {
                        this.startGame();
                    }, this),
                    (this._dialogPause = new e.DialogPause(this.game, this.world, 360, 200, this._board)),
                    this._dialogPause.position.set(this.world.centerX, t),
                    this._firstGame && (this._dialogStart.visible = !0),
                    this.onResize(this.game.width, this.game.height);
            }),
            (n.prototype.onSpacePressed = function () {
                !this.dialogOnScreen && this._board.snake.isMoving
                    ? (this._dialogPause.visible = !0)
                    : this._dialogPause.visible
                      ? (this._dialogPause.visible = !1)
                      : this.onKeyPressed();
            }),
            ...
            (n.prototype.onResize = function (t, e) {
                this.setView(t, e),
                    this._board && this._board.onResize(t, e),
                    this._dialogStart &&
                        ((t =
                            (e - this._board.savedHeight * this._board.scale.y) / 2 +
                            this._board.innerOffset.y * this._board.scale.y +
                            ((this._board.dimensions.y * this._board.blockSize) / 2) * this._board.scale.y),
                        this._dialogGameOver.position.set(this.world.centerX, t),
                        this._dialogPause.position.set(this.world.centerX, t),
                        this._dialogStart.position.set(this.world.centerX, t)),
                    this._ui && this._board && this._ui.onResize(this._board);
            }),
            ...
            (n.prototype.update = function () {
                var t, e;
                this.dialogOnScreen ||
                    ((t = Math.min(this.game.time.elapsedMS, 1e3 / 15)), this._gameOver) ||
                    ((this._blockInput = !1),
                    this._input.update(),
                    (e = this._input.direction),
            ...
            (n.prototype.onGameOver = function () {
                ...
                this._gameOver ||
                    ((this._gameOver = !0),
                    (t = this._score > App.settings.hiScore) &&
                        ((App.settings.hiScore = this._score),
                        this._ui.setBest(App.settings.hiScore),
    ...
    (function (t) {
        (e = t.SceneBase),
            ...
            (n.prototype.preload = function () {
                ...
                this.load.atlas(
                    "Sprites",
                    "".concat((t = "assets/atlas/"), "Sprites.png"),
                    "".concat(t, "Sprites.json")
                ),
                    this.load.json("Texts", "".concat("assets/text/", "text.json")),
                    this.onResize(this.game.width, this.game.height);
            }),
            (n.prototype.create = function () {
